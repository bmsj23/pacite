export default function Home() {
  return (
    ...
    <button className="mt-6 px-6 py-3 rounded-full bg-[var(--color-primary)] text-white font-medium shadow-md hover:bg-[var(--color-primary-light)] hover:shadow-lg transition-all duration-300 ease-in-out">
      Get Started
    </button>
