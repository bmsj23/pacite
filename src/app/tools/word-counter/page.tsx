  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen bg-gray-100 px-6">
      ...
      <textarea
        ...
        className="mt-8 w-full max-w-2xl h-40 p-4 border border-gray-300 rounded-lg text-black shadow-sm focus:outline-none focus:shadow-md transition duration-200 resize-none"
      ...
      {/* Button */}
      <button
        className="mt-6 px-6 py-3 bg-[var(--color-primary)] text-white font-medium rounded-lg shadow-md hover:bg-green-700 hover:shadow-lg transition-all duration-200"
